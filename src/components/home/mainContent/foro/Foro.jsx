  ...
  const crearNuevoTema = async () => {
    if (!estaLogueado) {
      return Swal.fire({
        ...
        text: "Debes iniciar sesión con un correo verificado para publicar un tema.",
        timer: 2500,
    ...
    if (!nuevoTema.title.trim() || !nuevoTema.desc.trim()) {
      return Swal.fire({
        ...
        text: "Completa todos los campos para publicar un tema.",
        timer: 2500,
        showConfirmButton: false,
        timerProgressBar: true,
      });
    ...
    try {
      ...
      Swal.fire({
        ...
        text: "Hubo un problema al crear el tema. Intenta de nuevo.",
        timer: 2000,
        showConfirmButton: false,
        timerProgressBar: true,
      });
  ...
  const enviarComentario = async (temaId, texto) => {
    if (!estaLogueado) {
      return Swal.fire({
        icon: "warning",
        title: "Acceso denegado",
        text: "Debes iniciar sesión con un correo verificado para comentar.",
        timer: 2500,
        showConfirmButton: false,
        timerProgressBar: true,
      });
    ...
    if (!texto || texto.trim() === "") {
      return Swal.fire({
        ...
        text: "Escribe algo antes de comentar.",
        timer: 2000,
        showConfirmButton: false,
        timerProgressBar: true,
      });
  ...
  const toggleLike = async (temaId) => {
    if (!estaLogueado) {
      return Swal.fire({
        icon: "warning",
        title: "Acceso denegado",
        text: "Debes iniciar sesión con un correo verificado para dar like.",
        timer: 2500,
        showConfirmButton: false,
        timerProgressBar: true,
      });
          ...
          <div className="new-topic">
            ...
            {estaLogueado ? (
              ...
              <div className="foro-login-msg">
                ...
                {usuario ? "Verifica tu correo para crear un tema." : "Inicia sesión para crear un tema."}
              </div>
            )}
          </div>
                ...
                <div className="box shadow flexSB">
                  <div className="text">
                    ...
                    <div className="date">
                      ...
                      <label>{val.autor || "Sin Autor"}</label>
                    </div>
                    ...
                    <div className="comment">
                      <i
                        ...
                        style={{
                          cursor: estaLogueado ? "pointer" : "default",
                    ...
                    {estaLogueado ? (
                      <div className="comment-section">
                        ...
                        <button
                          ...
                          onClick={() => enviarComentario(val.id, nuevoComentario[val.id])}
                        >
                          Send
                        </button>
                      </div>
                      ...
                      <div className="foro-login-msg">
                        <i className="fas fa-lock"></i>
                        {usuario ? "Verifica tu correo para comentar." : "Inicia sesión para comentar."}
                      </div>
                    )}
                  </div>
                </div>
